...
3. A permanent $34.99/year plan (approximately $2.92/month billed annually).
...
6. Configure and verify the final store-facing model: 7-day free trial, recurring $4.99/month, recurring $34.99/year, localized taxes/currency, and same-price renewal disclosure.
