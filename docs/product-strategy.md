...
| **Calora target** | **5** | **5** | **5** | **5** | **5** | One-tap capture, visible confidence, local-first reliability, plain $4.99 / $34.99 pricing. |
...
4. **Plain monetization:** no ads in the core loop, show the permanent $4.99 monthly and $34.99 annual (approximately $2.92/month billed annually) pricing, state the 7-day free trial and same-price renewal terms before purchase, and provide a visible cancel/manage link.
...
- Light, dark, and system themes; transparent 7-day free trial, $4.99/month, and $34.99/year (approximately $2.92/month billed annually) Pro presentation; export and local delete controls.
