# Google Play Store — Calora Store Listing Metadata
...
|---|---|---|---|
| 1 | Meet Calora | Smarter nutrition starts here. | Onboarding |
...
Content: Calora wordmark + tagline "Eat Smarter. Live Better." on brand-consistent background.
