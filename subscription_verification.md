...
- **Final Pricing Decision:** The U.S. annual price of **$35.99/year** is accepted as final. Customer-facing annual marketing displays **"$2.99/month, billed annually"**, while the transaction price remains $35.99/year.
...
- `lib/brand.ts` and all repository documentation (`docs/CALORAAPP_PRODUCT_METADATA.md`, `docs/calora-payment-billing-entitlements-certification.md`, `docs/calora-release-checklist.md`, `docs/product-strategy.md`) have been updated to reflect $35.99/year and $2.99/mo billed annually.
