...
export const PLANNER_MEAL_IMAGE_IDENTITIES = {
  ...
  'keto-chicken-zucchini': 'keto-chicken-zucchini',
  'keto-salmon-olive': 'keto-salmon-olive',
...
const PLANNER_MEAL_IMAGE_NAMES: Record<string, PlannerImageKey> = {
  ...
  'greek salad with plant feta': 'greek-salad',
  ...
  'lemon herb chicken with zucchini': 'keto-chicken-zucchini',
  'olive salmon with greens': 'keto-salmon-olive',
