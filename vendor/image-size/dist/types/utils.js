...
function readBox(input, offset) {
    ...
    // Zero-sized boxes are malformed for the parsers that consume this
    // helper. Reject them so callers cannot repeatedly revisit the same
    // offset on hostile JXL/HEIF input.
