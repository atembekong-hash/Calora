/**
 * Preferred meal pools keep each Program recognizable. Pools are ordered
 * preferences, not an authorization boundary; eligibility is enforced before
 * a meal can enter a generated or local week.
 */
