...
- **Pagination truthfulness:** Discover now uses the server-provided `nextOffset` to prefetch and load pages, including terminal exhaustion. It no longer infers continuation from page length.
