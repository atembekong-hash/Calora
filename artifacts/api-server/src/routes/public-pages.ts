...
router.get("/terms", (_req: Request, res: Response) => sendPage("Calora Terms of Use", "Terms governing use of the Calora nutrition and wellness service.", `
  ...
  <h2>Food image attribution</h2><p>Product images identified in the app as “Open Food Facts · CC BY-SA” are contributed by <a href="https://openfoodfacts.org">Open Food Facts</a> participants and reused under the Creative Commons Attribution-ShareAlike license. Product packaging may contain third-party trademarks and other protected material; images are shown only to identify the matched product.</p>
