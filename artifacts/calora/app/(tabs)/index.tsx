...
function WaterCard({
  ...
  return (
    <View style={styles.wellnessSection} accessibilityLabel={`Water tracking: ${normalizedWater} fluid ounces, ${cupsLogged} cups logged`}>
      <View style={[styles.wellnessCard, { flex: 0, width: '100%', minHeight: 0, backgroundColor: colors.card, borderColor: colors.border }]}>
...
function AnimatedWaterSlot({ filled, muted }: { filled: boolean; muted: string }) {
  ...
  return (
    <Animated.View style={[styles.waterSlot, animStyle]}>
      <Svg width={35} height={40} viewBox="0 0 24 28">
...
function makeStyles(f: number) {
  ...
  waterSlots: { flexDirection: 'row', alignItems: 'flex-end', gap: 4, height: 40, marginTop: 12, marginBottom: 14 },
  waterSlot: { flex: 1, height: 40, alignItems: 'center', justifyContent: 'flex-end' },
