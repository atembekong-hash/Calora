...
function makeStyles(f: number) {
  ...
  homeHeaderDate: { color: '#b6d8c2', fontFamily: 'Inter_600SemiBold', fontSize: 10 * f, letterSpacing: 0.5, textAlign: 'right', maxWidth: 146, textTransform: 'uppercase' },
   homeHeaderTitle: { color: '#ffffff', fontFamily: 'Inter_800ExtraBold', fontSize: 26 * f, letterSpacing: -0.8 },
  homeHeaderSubtitle: { color: '#d4eadc', fontFamily: 'Inter_500Medium', fontSize: 14 * f, marginTop: 6 },
  ...
  heroEyebrow: { fontFamily: 'Inter_700Bold', fontSize: 10 * f, letterSpacing: 1.2, textTransform: 'uppercase' },
  trustBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12 },
  ...
  livingRhythmBody: { fontFamily: 'Inter_500Medium', fontSize: 13 * f, lineHeight: 19, marginTop: 12, maxWidth: 300 },
  livingRhythmSignals: { flexDirection: 'row', alignItems: 'center', marginTop: 20 },
  ...
  livingRhythmDivider: { width: 1, height: 32, marginHorizontal: 16 },
  livingRhythmTracks: { flexDirection: 'row', gap: 14, marginTop: 20 },
  ...
  livingRhythmTrack: { height: 8, borderRadius: 4, overflow: 'hidden' },
  livingRhythmFill: { height: 8, borderRadius: 4 },
   quickLogSection: { marginBottom: 28 },
   quickLogHeading: { marginBottom: 16 },
   quickActions: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  quickAction: { flexGrow: 1, flexBasis: '46%', minHeight: 96, borderWidth: StyleSheet.hairlineWidth, borderRadius: 20, padding: 14, justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 4, elevation: 2 },
   quickActionPrimary: { shadowColor: '#17231f', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 5 },
  quickIcon: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  quickLabel: { fontFamily: 'Inter_600SemiBold', fontSize: 13 * f },
  ...
  recipeWidgetPages: { },
  recipeWidgetCard: { width: 322, height: 180, borderRadius: 18, overflow: 'hidden', position: 'relative' },
  recipeWidgetImage: { ...StyleSheet.absoluteFillObject },
  recipeWidgetCopy: { flex: 1, justifyContent: 'flex-end', padding: 16 },
  ...
  recipeWidgetFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 12 },
  ...
  dateNav: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: StyleSheet.hairlineWidth, borderRadius: 24, padding: 10, marginBottom: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 4, elevation: 2 },
  ...
  sectionCard: { borderWidth: StyleSheet.hairlineWidth, borderRadius: 24, padding: 20, marginBottom: 28, shadowColor: '#17231f', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.06, shadowRadius: 12, elevation: 4 },
  ...
  editCard: { borderTopLeftRadius: 32, borderTopRightRadius: 32, paddingHorizontal: 24, paddingTop: 12, paddingBottom: 32 },
