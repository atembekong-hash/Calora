...
function makeStyles(f: number) {
  ...
  mealList: { gap: 9 },
    mealCard: { overflow: 'hidden', flexDirection: 'row', minHeight: 98 },
    mealImage: { width: 88, minHeight: 98, alignSelf: 'stretch' },
   mealCardBody: { flex: 1, padding: 9 },
  mealCardTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    cardMoreButton: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', marginRight: -3, marginTop: -3 },
    mealTypeBadge: { minHeight: 19, paddingHorizontal: 6, borderRadius: 7, alignItems: 'center', justifyContent: 'center' },
  ...
  mealCalories: { fontFamily: 'Inter_600SemiBold', fontSize: 10 * f },
   mealName: { fontFamily: 'Inter_700Bold', fontSize: 13 * f, lineHeight: 16, marginTop: 5 },
    mealMetaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginTop: 3 },
    ...
    macroLine: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6 },
  macroText: { fontFamily: 'Inter_600SemiBold', fontSize: 9 * f },
   logMealButton: { marginLeft: 'auto', minHeight: 38, borderRadius: 10, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 3 },
   logMealButtonText: { fontFamily: 'Inter_700Bold', fontSize: 9.5 * f },
   editMealButton: { minHeight: 38, borderRadius: 10, paddingHorizontal: 8, borderWidth: 1, flexDirection: 'row', alignItems: 'center', gap: 3 },
