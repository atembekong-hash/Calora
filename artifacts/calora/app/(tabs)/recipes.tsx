...
function RecipeMeta({ recipe, colors, compact = false }: { recipe: Recipe | CaloraRecipe; colors: ReturnType<typeof useCalora>['colors']; compact?: boolean }) {
